<?php
	...
	$adress= $mysqli->real_escape_string(htmlspecialchars($_POST['adress']));
	...
	$dateRepair= $mysqli->real_escape_string(htmlspecialchars($_POST['dateRepair']));
	...
	echo "je suis fouuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu";
	echo $dateIn;
	echo "tu est  fouuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu";
